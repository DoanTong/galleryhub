...
import { LOGIN_ROUTE, SIGNUP_ROUTE } from "@/ultis/constants";
...
const Auth = () => {
    ...
    const validateLogin =  () =>{
      if(!email.length){
        toast.error("Phải có Email.")
        return false;
      }
      if(!password.length){
        toast.error("Phải có Password.")
        return false;
      }
      return true;
    };
    ...
    const validateSignup =  () =>{
      ...
      if(password !== confirmPassword){
        toast.error("Password và Confirm Password phải giống nhau.")
        return false;
      }
      return true;
    };
    ...
    return(
      <div className="h-[100vh] w-[100vw] flex items-center justify-center">
        <div className="h-[80vh] bg-white border-2 border-white text-opacity-90 shadow-2xl w-[88vw] md:w-[90vw] lg:w-[70vw] xl:w-[60vw] rounded-3xl grid xl:grid-cols-2">
          <div className="flex items-center flex-col gap-10 justify-center">
            <div className="flex items-center justify-center flex-col">
              ...
              <p className="font-medium text-center">Điền thông tin đăng nhập của bạn để được trải nghiệm Underdev chat app</p>
            </div>
            <div className="flex items-center justify-center w-full">
              <Tabs className="w-3/4" defaultValue="login">
                <TabsList className="flex items-center justify-center bg-transparent rounded-none w-full">
